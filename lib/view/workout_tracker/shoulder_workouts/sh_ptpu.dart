...
class sh_ptpu extends StatefulWidget {
  @override
  _sh_ptpuState createState() => _sh_ptpuState();
}

class _sh_ptpuState extends State<sh_ptpu> {
                ...
                onPressed: () {
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(builder: (context) => WorkoutPage(
                      nextWorkoutName: 'Reclined Rhomboid Squeezes',
                      redirectPage: sh_rrs(),
                    ),),
                  );
                },
            ...
            Row(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => sh_ccp(),
                    ),
                  );
                },
                style: ElevatedButton.styleFrom(
