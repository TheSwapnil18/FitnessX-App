...
import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_wpu.dart';
...
class arm_tsl extends StatefulWidget {
  @override
  _arm_tslState createState() => _arm_tslState();
}

class _arm_tslState extends State<arm_tsl> {
  ...
  void _handleCountdownFinish() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Triceps Stretch Right',
        redirectPage: arm_tsr(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_wpu(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
