import 'package:FitnessX_App/view/workout_tracker/shoulder_workouts/sh_as.dart';
...
class sh_sr extends StatefulWidget {
  @override
  _sh_srState createState() => _sh_srState();
}

class _sh_srState extends State<sh_sr> {
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => sh_sl(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
