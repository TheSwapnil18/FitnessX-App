...
class full_wdpu extends StatefulWidget {
  @override
  _full_wdpuState createState() => _full_wdpuState();
}

class _full_wdpuState extends State<full_wdpu> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(66); // Update user calories to 500

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Cobra Strech',
                        redirectPage: full_cs(),
                      ),
                    ),
                  );
                },
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => full_pu()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
