import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_accc.dart';
import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_td.dart';
...
class arm_acc extends StatefulWidget {
  @override
  _arm_accState createState() => _arm_accState();
}

class _arm_accState extends State<arm_acc> {
  ...
  void _handleCountdownFinish() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Arm Circles CounterClockwise',
        redirectPage: arm_accc(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_td(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
