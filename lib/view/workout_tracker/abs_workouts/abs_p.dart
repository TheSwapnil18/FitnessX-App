import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_ac_12.dart';
import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_lr.dart';
...
class abs_p extends StatefulWidget {
  @override
  _abs_pState createState() => _abs_pState();
}
...
class _abs_pState extends State<abs_p> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(500); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Abdominal Crunches',
        redirectPage: abs_ac_12(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => abs_lr(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
