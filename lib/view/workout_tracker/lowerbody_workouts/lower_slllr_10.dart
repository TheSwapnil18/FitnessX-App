import 'package:FitnessX_App/view/workout_tracker/lowerbody_workouts/lower_bl_14.dart';
...
class lower_slllr_10 extends StatefulWidget {
  @override
  _lower_slllr_10State createState() => _lower_slllr_10State();
}

class _lower_slllr_10State extends State<lower_slllr_10> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(212);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Backward Lunge',
                        redirectPage: lower_bl_14(),
                      ),
                    ),
                  );
                },
