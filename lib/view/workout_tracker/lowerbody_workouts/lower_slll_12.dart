import 'package:FitnessX_App/view/workout_tracker/lowerbody_workouts/lower_slllr_12.dart';
...
class lower_slll_12 extends StatefulWidget {
  @override
  _lower_slll_12State createState() => _lower_slll_12State();
}

class _lower_slll_12State extends State<lower_slll_12> {
  late VideoPlayerController _controller;

  @override
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/side-lying-left.mp4')
      ..initialize().then((_) {
        setState(() {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(172);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Side-Lying Leg Lift Right',
                        redirectPage: lower_slllr_12(),
                      ),
                    ),
                  );
                },
