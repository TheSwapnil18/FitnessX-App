...
import 'chest_bpu.dart';
import 'chest_hpu.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class chest_wapu_10 extends StatefulWidget {
  @override
  _chest_wapu_10State createState() => _chest_wapu_10State();
}

class _chest_wapu_10State extends State<chest_wapu_10> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(778);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Hindu Push-Ups',
                        redirectPage: chest_hpu(),
                      ),
                    ),
                  );
                },
