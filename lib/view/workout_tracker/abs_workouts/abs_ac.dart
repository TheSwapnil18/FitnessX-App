import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_jj.dart';
import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_rt.dart';
...
class abs_ac extends StatefulWidget {
  @override
  _abs_acState createState() => _abs_acState();
}

class _abs_acState extends State<abs_ac> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(410);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Russian Twist',
                        redirectPage: abs_rt(),
                      ),
                    ),
                  );
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_jj(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
