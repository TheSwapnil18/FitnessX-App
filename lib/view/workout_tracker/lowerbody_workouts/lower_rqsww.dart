...
import 'lower_ktcsl.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class lower_rqsww extends StatefulWidget {
  @override
  _lower_rqswwState createState() => _lower_rqswwState();
}

class _lower_rqswwState extends State<lower_rqsww> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(346); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Knee To Chest Stretch Left',
        redirectPage: lower_ktcsl(),
      ),),
    );
  }
