import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_jp.dart';
import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_lbcl.dart';
...
class arm_cpp extends StatefulWidget {
  @override
  _arm_cppState createState() => _arm_cppState();
}

class _arm_cppState extends State<arm_cpp> {
  late VideoPlayerController _controller;
  late Timer _timer;
  int _countdownSeconds = 16;
  ...
  void _handleCountdownFinish() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Leg Barbell Curl Left',
        redirectPage: arm_lbcl(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_jp(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
