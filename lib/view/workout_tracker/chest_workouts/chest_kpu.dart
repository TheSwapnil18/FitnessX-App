...
import 'chest_ipu.dart';
import 'chest_pu.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class chest_kpu extends StatefulWidget {
  @override
  _chest_kpuState createState() => _chest_kpuState();
}

class _chest_kpuState extends State<chest_kpu> {
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => chest_ipu(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
