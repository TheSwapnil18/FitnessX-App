import 'package:FitnessX_App/view/workout_tracker/lowerbody_workouts/lower_slll_10.dart';
...
class lower_slllr_12 extends StatefulWidget {
  @override
  _lower_slllr_12State createState() => _lower_slllr_12State();
}

class _lower_slllr_12State extends State<lower_slllr_12> {
  late VideoPlayerController _controller;

  @override
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/side-lying-right.mp4')
      ..initialize().then((_) {
        setState(() {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  // Update user calories to 300
                  await updateCalories(185);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Side-Lying Leg Lift Left',
                        redirectPage: lower_sllll_10(),
                      ),
                    ),
                  );
                },
