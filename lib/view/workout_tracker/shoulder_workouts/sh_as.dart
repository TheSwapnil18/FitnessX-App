...
import 'package:FitnessX_App/view/workout_tracker/shoulder_workouts/sh_sr.dart';
...
class sh_as extends StatefulWidget {
  @override
  _sh_asState createState() => _sh_asState();
}

class _sh_asState extends State<sh_as> {
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => sh_sr(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
