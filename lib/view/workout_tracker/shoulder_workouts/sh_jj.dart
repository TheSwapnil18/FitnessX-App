...
class sh_jj extends StatefulWidget {
  @override
  _sh_jjState createState() => _sh_jjState();
}

class _sh_jjState extends State<sh_jj> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(864); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Arm Raises',
        redirectPage: sh_ar(),
      ),),
    );
  }
