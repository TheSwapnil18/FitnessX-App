...
import 'abs_lr_14.dart';
import 'abs_mc_12.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class abs_ht_2 extends StatefulWidget {
  @override
  _abs_ht_2State createState() => _abs_ht_2State();
}

class _abs_ht_2State extends State<abs_ht_2> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(565);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Leg Raises',
                        redirectPage: abs_lr_14(),
                      ),
                    ),
                  );
                },
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_mc_12(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
