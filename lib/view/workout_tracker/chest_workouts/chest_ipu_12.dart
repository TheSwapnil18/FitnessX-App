...
import 'chest_wapu.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class chest_ipu_12 extends StatefulWidget {
  @override
  _chest_ipu_12State createState() => _chest_ipu_12State();
}

class _chest_ipu_12State extends State<chest_ipu_12> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(730);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Box Push-Ups',
                        redirectPage: chest_bpu(),
                      ),
                    ),
                  );
                },
