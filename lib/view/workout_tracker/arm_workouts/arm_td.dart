import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_sar.dart';
...
class arm_td extends StatefulWidget {
  @override
  _arm_tdState createState() => _arm_tdState();
}

class _arm_tdState extends State<arm_td> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(850);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Arm Circles Clockwise',
                        redirectPage: arm_acc(),
                      ),
                    ),
                  );
                },
