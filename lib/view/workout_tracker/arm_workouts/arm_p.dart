...
import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_pu.dart';
...
class arm_p extends StatefulWidget {
  @override
  _arm_pState createState() => _arm_pState();
}

class _arm_pState extends State<arm_p> {
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_dp(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
