...
class chest_jj extends StatefulWidget {
  @override
  _chest_jjState createState() => _chest_jjState();
}

class _chest_jjState extends State<chest_jj> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(650); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Incline Push-Ups',
        redirectPage: chest_ipu(),
      ),),
    );
  }
