...
import 'lower_lqsww.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class lower_dkr_10 extends StatefulWidget {
  @override
  _lower_dkr_10State createState() => _lower_dkr_10State();
}

class _lower_dkr_10State extends State<lower_dkr_10> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(310);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Left Quad Stretch With Wall',
                        redirectPage: lower_lqsww(),
                      ),
                    ),
                  );
                },
