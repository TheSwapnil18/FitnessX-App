...
class arm_ar extends StatefulWidget {
  @override
  _arm_arState createState() => _arm_arState();
}

class _arm_arState extends State<arm_ar> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(825); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Side Arm Raise',
        redirectPage: arm_sar(),
      ),),
    );
  }
