...
import 'chest_chs.dart';
import 'chest_hpu.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class chest_cs extends StatefulWidget {
  @override
  _chest_csState createState() => _chest_csState();
}

class _chest_csState extends State<chest_cs> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(798); // Update user calories to 500
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Chest Stretch',
        redirectPage: chest_chs(),
      ),),
    );
  }
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => chest_hpu(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
...
class AnotherPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Redirected from Fitness Page'),
      ),
    );
  }
}
