...
class sh_ar extends StatefulWidget {
  @override
  _sh_arState createState() => _sh_arState();
}

class _sh_arState extends State<sh_ar> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(888); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Rhomboid Pulls',
        redirectPage: sh_rp(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => sh_jj(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
