...
class abs_sr extends StatefulWidget {
  @override
  _abs_srState createState() => _abs_srState();
}

class _abs_srState extends State<abs_sr> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(645); // Update user calories to 500
