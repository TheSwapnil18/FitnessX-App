import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_mc.dart';
...
class abs_rt extends StatefulWidget {
  @override
  _abs_rtState createState() => _abs_rtState();
}

class _abs_rtState extends State<abs_rt> {
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_ac(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
