...
import 'package:FitnessX_App/view/workout_tracker/Fullbody_workouts/full_ipu.dart';

class full_jp extends StatefulWidget {
  @override
  _full_jpState createState() => _full_jpState();
}

class _full_jpState extends State<full_jp> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(10); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Incline Push-Ups',
        redirectPage: full_ipu(),
      ),),
    );
  }
