...
import 'lower_squats_10.dart';

class lower_squats_12 extends StatefulWidget {
  @override
  _lower_squats_12State createState() => _lower_squats_12State();
}

class _lower_squats_12State extends State<lower_squats_12> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  // Update user calories to 500
                  await updateCalories(132);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Squats',
                        redirectPage: lower_squats_10(),
                      ),
                    ),
                  );
                },
