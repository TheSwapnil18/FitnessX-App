...
import 'abs_ht_2.dart';
import 'abs_rt_32.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class abs_mc_12 extends StatefulWidget {
  @override
  _abs_mc_12State createState() => _abs_mc_12State();
}

class _abs_mc_12State extends State<abs_mc_12> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(550);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Heel Touch',
                        redirectPage: abs_ht_2(),
                      ),
                    ),
                  );
                },
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_rt_32(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
