...
class abs_sl extends StatefulWidget {
  @override
  _abs_slState createState() => _abs_slState();
}

class _abs_slState extends State<abs_sl> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(623); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Spine Lumber Twist Stretch Right',
        redirectPage: abs_sr(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => abs_cs(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
