...
class full_ipu extends StatefulWidget {
  @override
  _full_ipuState createState() => _full_ipuState();
}

class _full_ipuState extends State<full_ipu> {
  ...
  void updateWorkoutsNode(int currentDay) async {
    try {
      User? user = FirebaseAuth.instance.currentUser;
      if (user != null) {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(20); // Update user calories to 500
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => full_jp()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
