...
class arm_sar extends StatefulWidget {
  @override
  _arm_sarState createState() => _arm_sarState();
}

class _arm_sarState extends State<arm_sar> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(834); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Triceps Dips',
        redirectPage: arm_td(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_ar(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
