import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_sbsr.dart';
import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_tsr.dart';
...
class arm_sbsl extends StatefulWidget {
  @override
  _arm_sbslState createState() => _arm_sbslState();
}

class _arm_sbslState extends State<arm_sbsl> {
  ...
  void _handleCountdownFinish() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Standing Biceps Stretch Right',
        redirectPage: arm_sbsr(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_tsr(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
