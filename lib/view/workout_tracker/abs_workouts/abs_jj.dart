import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_ac.dart';
...
class abs_jj extends StatefulWidget {
  @override
  _abs_jjState createState() => _abs_jjState();
}

class _abs_jjState extends State<abs_jj> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(390); // Update user calories to 500
