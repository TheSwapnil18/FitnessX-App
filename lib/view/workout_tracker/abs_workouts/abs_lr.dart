import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_ht.dart';
...
class abs_lr extends StatefulWidget {
  @override
  _abs_lrState createState() => _abs_lrState();
}

class _abs_lrState extends State<abs_lr> {
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_ht(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
