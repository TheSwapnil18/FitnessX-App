...
import 'abs_ac_12.dart';
import 'abs_mc_12.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class abs_rt_32 extends StatefulWidget {
  @override
  _abs_rt_32State createState() => _abs_rt_32State();
}

class _abs_rt_32State extends State<abs_rt_32> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(535);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Mountain Climber',
                        redirectPage: abs_mc_12(),
                      ),
                    ),
                  );
                },
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_ac_12(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
