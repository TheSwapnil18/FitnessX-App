...
class arm_sbsr extends StatefulWidget {
  @override
  _arm_sbsrState createState() => _arm_sbsrState();
}

class _arm_sbsrState extends State<arm_sbsr> {
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_sbsl(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
