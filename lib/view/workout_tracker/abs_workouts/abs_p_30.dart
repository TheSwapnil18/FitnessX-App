...
class abs_p_30 extends StatefulWidget {
  @override
  _abs_p_30State createState() => _abs_p_30State();
}

class _abs_p_30State extends State<abs_p_30> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(588); // Update user calories to 500
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => abs_lr_14(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
