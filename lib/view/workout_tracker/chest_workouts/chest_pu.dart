...
class chest_pu extends StatefulWidget {
  @override
  _chest_puState createState() => _chest_puState();
}

class _chest_puState extends State<chest_pu> {
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => chest_pu(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
