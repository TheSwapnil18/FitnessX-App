import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_p.dart';
import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';
import '../../../common/color_extension.dart';
import '../next_workout.dart';
import 'abs_rt_32.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class abs_ac_12 extends StatefulWidget {
  @override
  _abs_ac_12State createState() => _abs_ac_12State();
}

class _abs_ac_12State extends State<abs_ac_12> {
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_p(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
