...
import 'lower_slll_12.dart';

class lower_squats_10 extends StatefulWidget {
  @override
  _lower_squats_10State createState() => _lower_squats_10State();
}

class _lower_squats_10State extends State<lower_squats_10> {
  late VideoPlayerController _controller;

  @override
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/squats.mp4')
      ..initialize().then((_) {
        setState(() {
