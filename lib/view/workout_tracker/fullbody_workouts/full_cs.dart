...
class full_cs extends StatefulWidget {
  @override
  _full_csState createState() => _full_csState();
}

class _full_csState extends State<full_cs> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(78); // Update user calories to 500
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Chest Stretch',
        redirectPage: full_chs(),
      ),),
    );
  }
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => full_wdpu(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
