...
class chest_chs extends StatefulWidget {
  @override
  _chest_chsState createState() => _chest_chsState();
}

class _chest_chsState extends State<chest_chs> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(810); // Update user calories to 500
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => chest_cs(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
