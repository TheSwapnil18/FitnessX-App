import 'package:FitnessX_App/view/workout_tracker/lowerbody_workouts/lower_ktcsr.dart';
...
class lower_ktcsl extends StatefulWidget {
  @override
  _lower_ktcslState createState() => _lower_ktcslState();
}

class _lower_ktcslState extends State<lower_ktcsl> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(360); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Knee To Chest Stretch Right',
        redirectPage: lower_ktcsr(),
      ),),
    );
  }
