...
class arm_jp extends StatefulWidget {
  @override
  _arm_jpState createState() => _arm_jpState();
}

class _arm_jpState extends State<arm_jp> {
  ...
  void _handleCountdownFinish() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Chest Press Pulse',
        redirectPage: arm_cpp(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_dpu(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
