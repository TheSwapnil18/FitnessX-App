import 'package:FitnessX_App/view/workout_tracker/arm_workouts/arm_sbsl.dart';
...
class arm_tsr extends StatefulWidget {
  @override
  _arm_tsrState createState() => _arm_tsrState();
}

class _arm_tsrState extends State<arm_tsr> {
  ...
  void _handleCountdownFinish() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Standing Biceps Stretch Left',
        redirectPage: arm_sbsl(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => arm_tsl(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
