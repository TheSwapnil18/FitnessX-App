import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_p_30.dart';
import 'package:FitnessX_App/view/workout_tracker/abs_workouts/abs_sl.dart';
...
class abs_cs extends StatefulWidget {
  @override
  _abs_csState createState() => _abs_csState();
}

class _abs_csState extends State<abs_cs> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(600); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Spine Lumber Twist Stretch Left',
        redirectPage: abs_sl(),
      ),),
    );
  }
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => abs_p_30(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
