...
import 'abs_p_30.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class abs_lr_14 extends StatefulWidget {
  @override
  _abs_lr_14State createState() => _abs_lr_14State();
}

class _abs_lr_14State extends State<abs_lr_14> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(570);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Plank',
                        redirectPage: abs_p_30(),
                      ),
                    ),
                  );
                },
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => abs_ht_2(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
