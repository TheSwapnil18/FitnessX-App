import 'package:FitnessX_App/view/workout_tracker/chest_workouts/chest_kpu.dart';
import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';
import '../../../common/color_extension.dart';
import '../Fullbody_workouts/full_kpu.dart';
import '../next_workout.dart';
import 'chest_jj.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class chest_ipu extends StatefulWidget {
  @override
  _chest_ipuState createState() => _chest_ipuState();
}

class _chest_ipuState extends State<chest_ipu> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(666);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Knee Push-Ups',
                        redirectPage: chest_kpu(),
                      ),
                    ),
                  );
                },
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => chest_jj(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
