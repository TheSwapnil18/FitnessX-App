import 'package:FitnessX_App/view/workout_tracker/chest_workouts/chest_wapu_10.dart';
import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';
import '../../../common/color_extension.dart';
import '../next_workout.dart';
import 'chest_cs.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class chest_hpu extends StatefulWidget {
  @override
  _chest_hpuState createState() => _chest_hpuState();
}

class _chest_hpuState extends State<chest_hpu> {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await updateCalories(785);

                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WorkoutPage(
                        nextWorkoutName: 'Cobra Stretch',
                        redirectPage: chest_cs(),
                      ),
                    ),
                  );
                },
