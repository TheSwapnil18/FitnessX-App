...
import 'package:FitnessX_App/view/workout_tracker/lowerbody_workouts/lower_squats_12.dart';

class lower_jp extends StatefulWidget {
  @override
  _lower_jpState createState() => _lower_jpState();
}

class _lower_jpState extends State<lower_jp> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(110); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Squats',
        redirectPage: lower_squats_12(),
      ),),
    );
  }
