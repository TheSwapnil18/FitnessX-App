...
import 'lower_rqsww.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';

class lower_lqsww extends StatefulWidget {
  @override
  _lower_lqswwState createState() => _lower_lqswwState();
}

class _lower_lqswwState extends State<lower_lqsww> {
  ...
  void _handleCountdownFinish() {
    ...
    updateCalories(325); // Update user calories to 500
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => WorkoutPage(
        nextWorkoutName: 'Right Quad Stretch With Wall',
        redirectPage: lower_rqsww(),
      ),),
    );
  }
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        _handleCountdownFinish(); // Proceed with countdown finish logic
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.transparent, // Make button transparent
                        elevation: 0, // Remove default elevation
